...
Para generar nuestro archivo realizamos las siguentes operaciones:
...
Representando esta informaci?n con un gráfico de dispersión podemos ver que la distribuci?n se asemeja notablemente al mapamundi:
...
Despues de ver la localización de los servidores, vamos a decodificar los datos y a parsear los headers para obtener información más detallada.
