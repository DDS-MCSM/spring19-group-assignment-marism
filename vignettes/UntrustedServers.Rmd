...
zworld <- latlong2map(data.frame(x=df.cves$longitude, y=df.cves$latitude), "world")
...
Normalizamos los resultado por el numero de servidores que hay en cada región: 
