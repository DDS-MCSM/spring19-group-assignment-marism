...
Nos faltaría extraer de cada servidor, que criticidad tiene cada vulnerabilidad, para poder mostrar con mas fidelidad los restudos. 



Normalizamos los resultado por el número de servidores que hay en cada región: 




Lo correlacionamos con los datos del PIB:
